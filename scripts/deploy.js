...
async function main() {
  ...
  const erc201 = await hre.ethers.getContractAt("ERC20", asset);
  await erc201.approve(poolAddress, amount1);
  await erc201.transfer(connectorAddr, amount1);
  ...
  await erc201.approve(poolAddress, amount2);
  await erc201.transfer(connectorAddr, amount2);
  ...
  await erc201.approve(poolAddress, amount3);
  await erc201.transfer(connectorAddr, amount3);
  ...
  await erc201.approve(poolAddress, amount4);
  await erc201.transfer(connectorAddr, amount4);
